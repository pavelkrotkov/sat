...
_FIXTURE_INCORRECT = (SNAP_DIR /
    "sat-practice-test-7-reading-and-writing-module-2-7-7-reading-and-writing-d-b-inc.html")
_FIXTURE_CORRECT = (SNAP_DIR /
    "sat-practice-test-4-reading-and-writing-module-1-1-1-reading-and-writing-correct.html")


@pytest.mark.skipif(not _FIXTURE_INCORRECT.exists(),
                    reason="parse_snapshot fixture not in working tree "
                           "(artifacts/html/ is gitignored; see #36)")
...
@pytest.mark.skipif(not _FIXTURE_CORRECT.exists(),
                    reason="parse_snapshot fixture not in working tree "
                           "(artifacts/html/ is gitignored; see #36)")
...
@pytest.mark.skipif(not SNAP_DIR.exists() or
                    not any(SNAP_DIR.glob("*reading-and-writing*.html")),
