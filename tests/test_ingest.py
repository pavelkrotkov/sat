...
def _rec(uid, test="SAT Practice Test 4", num=1, module="Module 1",
         status="Incorrect", my="B; Incorrect", key="A"):
    # distinct passage text per uid so fingerprints differ unless a test
    # deliberately duplicates content
    snap = f"artifacts/html/sat-practice-test-4-reading-and-writing-module-1-{num}-{num}-reading-and-writing-correct.html"
    return {
        ...
        "answer_choices": [], "explanation": "Choice A is the best answer.",
        "images": [], "html_snapshot_path": "",
    }
